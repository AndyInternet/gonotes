...
var (
	noteAllColumns            = []string{"id", "created_at", "updated_at", "title", "body"}
	noteColumnsWithoutDefault = []string{"title"}
	noteColumnsWithDefault    = []string{"id", "created_at", "updated_at", "body"}
